...
'''.encode('ascii')
    ...
    path = write_wheel(
        ...
        metadata=[
            ...
            ("Requires-Python", "~=3.5"),
            ("Project-URL", "homepage, https://columnar.tech/dbc"),
            ("Project-URL", "documentation, https://docs.columnar.tech/dbc/"),
            ("Project-URL", "tracker, https://github.com/columnar-tech/dbc/issues"),
