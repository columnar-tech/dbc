...
To install a specific version, download the script first and run with the `-Version` parameter:

```sh
Invoke-WebRequest -Uri https://dbc.columnar.tech/install.ps1 -OutFile install.ps1
